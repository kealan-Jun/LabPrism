...
def main():
    ...
    parser.add_argument('--roles', nargs='+', choices=['first_person', 'third_person'], default=['first_person', 'third_person'])
    parser.add_argument('--report-name', default='static-engine-candidate-640')
    parser.add_argument('--candidate-key', default='candidate_engine')
    parser.add_argument('--baseline-key', default='service_engine')
    parser.add_argument('--summary-name', default='fine-engine-report.json')
